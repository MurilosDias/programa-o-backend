...
public class Aula09Objetos {
    public static void main(String[] args) {
         ...
         * e funcionalidades.
         * 
         * Eles herdam funções da classe mãe java.lang.Object, é correto afirma que java.lang.Object é uma super classe
         * de qualquer outra classe ou tipo abstrato.
         */
        Integer numero = 10; // Tipo abstrato
        int numero2 = 10; // Tipo primitivo

        // Retorna se a variáveel/classe é uma instância de outra classe
        System.out.println(numero instanceoF Object);

        // Método compereTo pertence ao tipo abstrato Integer
